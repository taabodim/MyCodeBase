...
//    private final MessageCounterHandler handler = new MessageCounterHandler();
...
//        }
//
//        ringBuffer.addGatingSequences(batchEventProcessor.getSequence()); // connect the batch processor to ringBuffer sequence
//    }
//
//    ///////////////////////////////////////////////////////////////////////////////////////////////
//
...
//        for (int i = 0; i < NUM_PUBLISHERS; i++)
//        {
//            futures[i] = executor.submit(queuePublishers[i]);
//        }
...
//        System.out.println(" Queue does "+opsPerSecond+ " ");
////        queueProcessor.halt();
...
//        }
//        
//        executor.submit(batchEventProcessor); //batch processor runs
//
//        long start = System.currentTimeMillis();
//        cyclicBarrier.await();
//
...
//
//        long opsPerSecond = (ITERATIONS) / (System.currentTimeMillis() - start);
//        System.out.println(" Disruptor does "+opsPerSecond+ " ");
//        batchEventProcessor.halt(); //batch processor stops
//
//        return opsPerSecond;
//    }
//}
